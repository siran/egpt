...
export const CONFIG_SCHEMA = {
  ...
  room:         'room behaviour: { on_join: "lazy" (default — saved sessions load as data; brains spin up on first @session use), "eager" (auto-/attach every saved session on /room join — opens Chrome tabs, starts codex processes), "off" (do not load saved sessions at all on join — start clean) }',
};
