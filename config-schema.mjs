...
export const CONFIG_SCHEMA = {
  ...
  whatsapp_cdp: 'extension-only WhatsApp via CDP (drives web.whatsapp.com). v1 single-chat: receives + sends in the currently-active conversation. { enabled, chat_id (auto-captured), client_name (default "wa-cdp") }. Disabled by default; opt in by setting enabled:true. Requires a logged-in web.whatsapp.com tab in the brain Chrome session. See BRIDGES_CDP_SPEC.md.',
