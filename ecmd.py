...
fixed_e_py = r"""#!/usr/bin/env python3
\"\"\"
...
Path("patch_stream_fix_e.py").write_text(f'from pathlib import Path\nPath("e.py").write_text("""{fixed_e_py}""")\nprint("✅ e.py updated with streaming fix.")')
