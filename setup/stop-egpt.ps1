...
#   powershell -ExecutionPolicy Bypass -File .\setup\stop-egpt.ps1 -EgptHome "$env:USERPROFILE\.egpt-secondary"
...
#     ~/.egpt -> egpt-daemon, ~/.egpt-secondary -> egpt-secondary-daemon (setup/install-nssm-service.ps1).
if (-not $ServiceName) {
