...
// isContextOverflowError, isDeadSessionError, isBrainFailureResult moved to
// src/brain-errors.mjs (pure predicates v2 needs without dragging in the rest
// of this old-spine file) and imported above; re-exported here so existing
// importers are unchanged. dispatch.mjs's own runDefaultBrainTurn still calls
// these directly, hence the local import rather than a bare re-export.
export { isContextOverflowError, isDeadSessionError, isBrainFailureResult };
