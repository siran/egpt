...
export const COMMANDS = [
  ...
  { cmd: '/oracle',         surface: 'shell',     usage: '/oracle @waN [--keep [N]] | /oracle stop [@waN] | /oracle list', desc: 'summon a Genie in a WA chat. Emerges from a bottle, accepts N replies as wishes, routes each through a brain (default @e). Default 1 wish; --keep alone = 3 wishes (genie default); --keep N for custom (cap 12). Each answered wish ticks N down; on 0 the genie waves goodbye and the bottle empties. /oracle stop retires early. Multiple genies run in parallel across chats; busy_behavior config controls mid-thinking replies. Q+A flows into the shell.' },
