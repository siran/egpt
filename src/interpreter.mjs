...
export const COMMANDS = [
  ...
  { cmd: '/radio',          surface: 'shell',     usage: '/radio | /radio join [<radio>] | /radio leave | /radio say <text>', desc: 'which radio the CURRENT CONVERSATION\'s room relays to, and /radio say airs text as your voice', wired: true },
