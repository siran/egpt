...
// We don't know the proxy host from chrome.* APIs, so default to the
// standard local proxy. Override via chrome.storage.sync `bus_url` if
// the user runs the proxy on a different port/host.
