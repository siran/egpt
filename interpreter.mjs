...
export const COMMANDS = [
  ...
  { cmd: '/oracle',         surface: 'shell',     usage: '/oracle @waN | /oracle stop [@waN] | /oracle list',       desc: 'summon a long-running mystical Oracle in a WA chat — a self-editing spinner message that anyone in the chat can reply to with a question. The bridge routes the question through a brain (default @e, configurable via oracle.brain), edits a 🔮 thinking placeholder into the answer as a reply, retires the spinner. Multiple oracles run in parallel across chats; busy_behavior config controls what happens to replies that arrive mid-think.' },
