...
export const COMMANDS = [
  ...
  { cmd: '/movie',          surface: 'shell',     usage: '/movie @waN <preset> | --frames "a|b|c" [--ms N]', desc: 'play a short emoji animation in a WA chat by editing a single message frame-by-frame. presets: alien, sparkler, fireworks, heart, fire, rocket, dance, rainbow, loading, scan. /movie list enumerates them.' },
